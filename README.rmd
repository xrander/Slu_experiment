...
We estimate the average of the two diameters, we also square the result to get values needed to estimate the quadratic mean then we calculate the basal area
...
Given the figures, we need extra information to be able to estimate the density of the stand. To do that, we estimate the plot density then extrapolate to a hectare
