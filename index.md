...
<img src="https://i0.wp.com/odlandestadsbasarer.se/wp-content/uploads/2017/09/SLU-2.jpg?ssl=1" height="50" weight="50"/>
<br> *slu.se* <br>
...
accessories, kitchen appliances and other home services. Sverige
LantbruksUniversitet (SLU) or Swedish Agricultural University is a stand
out research university in Sweden. This university is not under the
Ministry of Education like other University in Sweden, but under the
...
<img src="http://www.chemical-ecology.net/alg56b.gif" width="800" height="600"/>
...
and other universities and research institutes in Sweden. Some of the
data used for this analysis were provided mainly by this research
station and have been [uploaded
...
-   [**Fertilization Experiment**](fertilizer.html): Total deposition of inorganic N (NO3-N + NH4-N) to spruce forest 2017, according to the MATCH model. The black dots are the three modeling sites: Högbränna in Northern Sweden, Södra Averstad in Central Sweden and Västra Torup in Southern Sweden. Source: Lucander et al. (2021)
...
-   [**Cuttings Experiment**](cuttings.html):

<img src="https://www.sgaonline.org.au/images/pics/hardwoodcuttings.jpg" width="400" height="600"/> <br> *source: Sustainable Gardening Australia* <br>
...
-   [**Thinning Frequency and Intensity Experiment**](pct.html): Basic data exploration and data visualization on a stand after being thinned giving insight on the influence of thinning frequency and/or intensity on some growth yield parameters.

-   [**Clone Trial Experiment**](clone.html): Experiment to test the effect of fertilization on the performance of different clones.

-   [**Growth Experiment**](growth_experiment.html): Estimation of some forestry growth parameters.

-   [**Spacing Experiment**](spacing_experiment.html): Experiment to test the effect of spacing density on the diameter and basal of a stand.

-   [**Thinning Experiment on Scots Pine**](Thinning_experiment.html):
    <br>
...
-   [**Mixed Forest Experiment**](mixed_forest.html): Volume estimation between pure monoculture and a mixed forest of 80:20 of monoculture and 50:50 of monoculture.

-   [**Site Preparation Experiment**](lodgepole.html): A site preparation experiment to evaluate the growth and survival of lodgepole pine under scarified and unscarified site.
